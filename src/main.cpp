...
uint256 hashGenesisBlock("0x58e0139fc6e79a140b0e0840b47873c24cba619e031bc0b514af3709898783e5");
...
const string strMessageMagic = "PuffCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 60 * 60; // PuffCoin: 1 hour
static const int64 nTargetSpacing = 60; // PuffCoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal puffcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PuffCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xeaedbfe246c5f536576ed252cc46e6793c848a0b9fb5e29170c7f2785f994edf");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Puffcoin: 25.09.2017 https://puff.amcoin.info/";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1506356965; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1009129;

        if (fTestNet)
        {
            block.nTime    = 1506338091;
            block.nNonce   = 443285;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x729d60beb781a4291fafac495a9cd0d4b1777b331c8074f9e4278e45c6fc6c2b"));
